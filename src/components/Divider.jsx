...
if (type === 'dive') {
  return (
    <section className="relative h-32 bg-gradient-to-b from-lime-200 to-cyan-400 overflow-hidden">
      {/* Add background color to avoid white space under wave */}
      <div className="absolute inset-0 bg-cyan-400 z-0" />
